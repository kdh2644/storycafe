...
<div class="col-sm-12">
	...
	<div class="col-sm-12">
		<div class="col-sm-12" align="left" style="margin-bottom: 20px;">
			<span><font size="3px" style="color: #108f50;">첨부파일 : </font></span>
			<span><input type="hidden" id="bseq" name="bseq" value="${article.bseq}">
			<a href="<c:url value='/bbs/fileDownload.cafe?bseq=${article.bseq}'/>"><font size="3px" style="color: black;">${article.originFile}</font></a><font size="3px" style="color: #108f50;">(${article.fileSize}kb)</font>
			</span>
		</div>	
	</div>
</div>
