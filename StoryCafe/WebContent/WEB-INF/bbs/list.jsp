...
function searchArticle() {
	document.getElementById("searchForm").action = "${root}/bbs/list.cafe";
...
function myArticle(myid) {
	...
	document.getElementById("commonForm").action = "${root}/bbs/list.cafe";
...
<c:forEach var="article" items="${articlelist}">		
		<tbody>
			<tr>
				...
				<a href="javascript:viewArticle('${bcode}', '${pg}', '${key}', '${word}', '${article.seq}');">${article.subject}
<c:if test="${article.bseq != null}">				
